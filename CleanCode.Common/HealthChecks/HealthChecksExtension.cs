...
namespace CleanCode.Common.HealthChecks
{
    ...
    {        
        public static void AddBasicHealthChecks(this WebApplicationBuilder builder)
        {
            builder.Services.AddHealthChecks()
                .AddCheck("Liveness", () => HealthCheckResult.Healthy("Application is alive"), tags: ["liveness"])
                .AddCheck("Readiness", () => HealthCheckResult.Healthy("Application is ready"), tags: ["readiness"]);
        }
